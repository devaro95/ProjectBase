...
class LoginViewModel(private val loginUseCase: LoginUseCase) :
    BaseViewModel<LoginState, LoginNavigator.Navigation>() {
...
//            else it.executeLoginUseCase()
    ...
    private fun LoginState.fieldsAreValid() =
        email.isEmpty() || password.isEmpty() || password.length < MIN_PASSWORD_LENGTH
